...
if (!class_exists('CustomTranslationFiles_AdminPageFramework_Registry', false)):
    abstract class CustomTranslationFiles_AdminPageFramework_Registry_Base {
    ...
    final class CustomTranslationFiles_AdminPageFramework_Registry extends CustomTranslationFiles_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['CustomTranslationFiles_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['CustomTranslationFiles_AdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('CustomTranslationFiles_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['CustomTranslationFiles_AdminPageFramework_InclusionClassFilesHeader']);
        }
...
if (!class_exists('CustomTranslationFiles_AdminPageFramework_Bootstrap', false)):
    final class CustomTranslationFiles_AdminPageFramework_Bootstrap {
        static private $_bLoaded = false;
        public function __construct($sLibraryPath) {
            if (!$this->_isLoadable()) {
                return;
            }
            CustomTranslationFiles_AdminPageFramework_Registry::setUp($sLibraryPath);
            if (CustomTranslationFiles_AdminPageFramework_Registry::$bIsMinifiedVersion) {
                return;
            }
            $this->_include();
        }
        ...
        private function _include() {
            include (CustomTranslationFiles_AdminPageFramework_Registry::$sAutoLoaderPath);
            new CustomTranslationFiles_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('CustomTranslationFiles_AdminPageFramework_MinifiedVersionHeader', 'CustomTranslationFiles_AdminPageFramework_BeautifiedVersionHeader',),), CustomTranslationFiles_AdminPageFramework_Registry::$aClassFiles);
            self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
            if (self::$_bXDebug) {
                new CustomTranslationFiles_AdminPageFramework_Utility;
                new CustomTranslationFiles_AdminPageFramework_WPUtility;
            }
        }
        static private $_bXDebug;
    }
    new CustomTranslationFiles_AdminPageFramework_Bootstrap(__FILE__);
endif;
