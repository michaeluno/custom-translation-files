...
abstract class CustomTranslationFiles_AdminPageFramework_PageMetaBox_Router extends CustomTranslationFiles_AdminPageFramework_MetaBox_View {
...
abstract class CustomTranslationFiles_AdminPageFramework_PageMetaBox_Model extends CustomTranslationFiles_AdminPageFramework_PageMetaBox_Router {
...
abstract class CustomTranslationFiles_AdminPageFramework_PageMetaBox_View extends CustomTranslationFiles_AdminPageFramework_PageMetaBox_Model {
}
abstract class CustomTranslationFiles_AdminPageFramework_PageMetaBox_Controller extends CustomTranslationFiles_AdminPageFramework_PageMetaBox_View {
...
abstract class CustomTranslationFiles_AdminPageFramework_PageMetaBox extends CustomTranslationFiles_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'custom-translation-files') {
