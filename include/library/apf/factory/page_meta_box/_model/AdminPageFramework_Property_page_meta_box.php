...
class CustomTranslationFiles_AdminPageFramework_Property_page_meta_box extends CustomTranslationFiles_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'custom-translation-files', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aCustomTranslationFiles_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aCustomTranslationFiles_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aCustomTranslationFiles_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aCustomTranslationFiles_AdminPageFramework', 'aPageClasses'));
