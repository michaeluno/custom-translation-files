...
abstract class CustomTranslationFiles_AdminPageFramework_Router extends CustomTranslationFiles_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'custom-translation-files') {
        $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'CustomTranslationFiles_AdminPageFramework_Property_' . $this->_sStructureType;
...
abstract class CustomTranslationFiles_AdminPageFramework_Model_Form extends CustomTranslationFiles_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'custom-translation-files') {
        ...
        new CustomTranslationFiles_AdminPageFramework_Model__FormEmailHandler($this);
    ...
    public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        new CustomTranslationFiles_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
...
abstract class CustomTranslationFiles_AdminPageFramework_View_Form extends CustomTranslationFiles_AdminPageFramework_Model_Form {
...
abstract class CustomTranslationFiles_AdminPageFramework_Controller_Form extends CustomTranslationFiles_AdminPageFramework_View_Form {
    ...
    public function getValue() {
        ...
        return CustomTranslationFiles_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
...
abstract class CustomTranslationFiles_AdminPageFramework_Model_Page extends CustomTranslationFiles_AdminPageFramework_Controller_Form {
    public function _replyToFinalizeInPageTabs() {
        ...
        foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
            ...
            $_oFormatter = new CustomTranslationFiles_AdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
...
abstract class CustomTranslationFiles_AdminPageFramework_View_Page extends CustomTranslationFiles_AdminPageFramework_Model_Page {
    public function _replyToEnablePageMetaBoxes() {
        new CustomTranslationFiles_AdminPageFramework_View__PageMetaboxEnabler($this);
    }
    public function _replyToEnqueuePageAssets() {
        new CustomTranslationFiles_AdminPageFramework_View__Resource($this);
    }
    ...
    protected function _renderPage($sPageSlug, $sTabSlug = null) {
        $_oPageRenderer = new CustomTranslationFiles_AdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
        $_oPageRenderer->render();
    }
}
abstract class CustomTranslationFiles_AdminPageFramework_Controller_Page extends CustomTranslationFiles_AdminPageFramework_View_Page {
...
abstract class CustomTranslationFiles_AdminPageFramework_Model_Menu extends CustomTranslationFiles_AdminPageFramework_Controller_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'custom-translation-files') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
        }
        new CustomTranslationFiles_AdminPageFramework_Model_Menu__RegisterMenu($this);
    }
}
abstract class CustomTranslationFiles_AdminPageFramework_View_Menu extends CustomTranslationFiles_AdminPageFramework_Model_Menu {
}
abstract class CustomTranslationFiles_AdminPageFramework_Controller_Menu extends CustomTranslationFiles_AdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink) {
        ...
        $_oFormatter = new CustomTranslationFiles_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage) {
        ...
        $_oFormatter = new CustomTranslationFiles_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
        $_aSubMenuPage = $_oFormatter->get();
        $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
    }
}
abstract class CustomTranslationFiles_AdminPageFramework_Model extends CustomTranslationFiles_AdminPageFramework_Controller_Menu {
}
abstract class CustomTranslationFiles_AdminPageFramework_View extends CustomTranslationFiles_AdminPageFramework_Model {
    public function content($sContent) {
        return $sContent;
    }
}
abstract class CustomTranslationFiles_AdminPageFramework_Controller extends CustomTranslationFiles_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new CustomTranslationFiles_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, '_isInThePage'),));
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return CustomTranslationFiles_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class CustomTranslationFiles_AdminPageFramework extends CustomTranslationFiles_AdminPageFramework_Controller {
    protected $_sStructureType = 'admin_page';
    public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'custom-translation-files') {
    ...
    private function _getCallerPath($sCallerPath) {
        ...
        $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? CustomTranslationFiles_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
