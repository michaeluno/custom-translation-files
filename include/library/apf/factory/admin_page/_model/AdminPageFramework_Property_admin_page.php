...
class CustomTranslationFiles_AdminPageFramework_Property_admin_page extends CustomTranslationFiles_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'custom-translation-files') {
        ...
        $GLOBALS['aCustomTranslationFiles_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aCustomTranslationFiles_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aCustomTranslationFiles_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
