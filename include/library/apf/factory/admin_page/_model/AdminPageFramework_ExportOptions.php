...
abstract class CustomTranslationFiles_AdminPageFramework_CustomSubmitFields extends CustomTranslationFiles_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class CustomTranslationFiles_AdminPageFramework_ExportOptions extends CustomTranslationFiles_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo CustomTranslationFiles_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
