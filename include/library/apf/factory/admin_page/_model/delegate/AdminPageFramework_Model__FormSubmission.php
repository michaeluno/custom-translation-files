...
abstract class CustomTranslationFiles_AdminPageFramework_Model__FormSubmission_Base extends CustomTranslationFiles_AdminPageFramework_FrameworkUtility {
...
class CustomTranslationFiles_AdminPageFramework_Model__FormSubmission extends CustomTranslationFiles_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new CustomTranslationFiles_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
