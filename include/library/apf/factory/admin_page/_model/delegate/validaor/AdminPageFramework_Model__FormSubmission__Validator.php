...
class CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator_Base extends CustomTranslationFiles_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator extends CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator__Link', 'CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator__Import', 'CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator__Export', 'CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
