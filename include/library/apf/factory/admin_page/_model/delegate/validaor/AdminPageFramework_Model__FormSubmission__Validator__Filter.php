...
class CustomTranslationFiles_AdminPageFramework_Model__FormSubmission__Validator__Filter extends CustomTranslationFiles_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
