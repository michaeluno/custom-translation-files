...
abstract class CustomTranslationFiles_AdminPageFramework_MetaBox_Router extends CustomTranslationFiles_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'custom-translation-files') {
...
abstract class CustomTranslationFiles_AdminPageFramework_MetaBox_Model extends CustomTranslationFiles_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'custom-translation-files') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new CustomTranslationFiles_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class CustomTranslationFiles_AdminPageFramework_MetaBox_View extends CustomTranslationFiles_AdminPageFramework_MetaBox_Model {
...
abstract class CustomTranslationFiles_AdminPageFramework_MetaBox_Controller extends CustomTranslationFiles_AdminPageFramework_MetaBox_View {
...
abstract class CustomTranslationFiles_AdminPageFramework_MetaBox extends CustomTranslationFiles_AdminPageFramework_MetaBox_Controller {
