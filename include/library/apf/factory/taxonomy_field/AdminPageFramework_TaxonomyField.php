...
abstract class CustomTranslationFiles_AdminPageFramework_TaxonomyField_Router extends CustomTranslationFiles_AdminPageFramework_Factory {
...
abstract class CustomTranslationFiles_AdminPageFramework_TaxonomyField_Model extends CustomTranslationFiles_AdminPageFramework_TaxonomyField_Router {
...
abstract class CustomTranslationFiles_AdminPageFramework_TaxonomyField_View extends CustomTranslationFiles_AdminPageFramework_TaxonomyField_Model {
...
abstract class CustomTranslationFiles_AdminPageFramework_TaxonomyField_Controller extends CustomTranslationFiles_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class CustomTranslationFiles_AdminPageFramework_TaxonomyField extends CustomTranslationFiles_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'custom-translation-files') {
