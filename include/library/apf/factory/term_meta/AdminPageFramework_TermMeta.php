...
abstract class CustomTranslationFiles_AdminPageFramework_TermMeta_Router extends CustomTranslationFiles_AdminPageFramework_TaxonomyField_Controller {
}
abstract class CustomTranslationFiles_AdminPageFramework_TermMeta_Model extends CustomTranslationFiles_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new CustomTranslationFiles_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class CustomTranslationFiles_AdminPageFramework_TermMeta_View extends CustomTranslationFiles_AdminPageFramework_TermMeta_Model {
...
abstract class CustomTranslationFiles_AdminPageFramework_TermMeta_Controller extends CustomTranslationFiles_AdminPageFramework_TermMeta_View {
}
abstract class CustomTranslationFiles_AdminPageFramework_TermMeta extends CustomTranslationFiles_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'custom-translation-files') {
