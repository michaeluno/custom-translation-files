...
abstract class CustomTranslationFiles_AdminPageFramework_Widget_Router extends CustomTranslationFiles_AdminPageFramework_Factory {
...
abstract class CustomTranslationFiles_AdminPageFramework_Widget_Model extends CustomTranslationFiles_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new CustomTranslationFiles_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class CustomTranslationFiles_AdminPageFramework_Widget_View extends CustomTranslationFiles_AdminPageFramework_Widget_Model {
...
abstract class CustomTranslationFiles_AdminPageFramework_Widget_Controller extends CustomTranslationFiles_AdminPageFramework_Widget_View {
...
abstract class CustomTranslationFiles_AdminPageFramework_Widget extends CustomTranslationFiles_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'custom-translation-files') {
