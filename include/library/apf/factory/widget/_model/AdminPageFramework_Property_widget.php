...
class CustomTranslationFiles_AdminPageFramework_Property_widget extends CustomTranslationFiles_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'custom-translation-files', $sStructureType) {
