...
abstract class CustomTranslationFiles_AdminPageFramework_UserMeta_Router extends CustomTranslationFiles_AdminPageFramework_Factory {
...
abstract class CustomTranslationFiles_AdminPageFramework_UserMeta_Model extends CustomTranslationFiles_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new CustomTranslationFiles_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class CustomTranslationFiles_AdminPageFramework_UserMeta_View extends CustomTranslationFiles_AdminPageFramework_UserMeta_Model {
...
abstract class CustomTranslationFiles_AdminPageFramework_UserMeta_Controller extends CustomTranslationFiles_AdminPageFramework_UserMeta_View {
...
abstract class CustomTranslationFiles_AdminPageFramework_UserMeta extends CustomTranslationFiles_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'custom-translation-files') {
