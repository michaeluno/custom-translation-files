...
abstract class CustomTranslationFiles_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'CustomTranslationFiles_AdminPageFramework_Form_', 'oPageLoadInfo' => 'CustomTranslationFiles_AdminPageFramework_PageLoadInfo_', 'oResource' => 'CustomTranslationFiles_AdminPageFramework_Resource_', 'oHelpPane' => 'CustomTranslationFiles_AdminPageFramework_HelpPane_', 'oLink' => 'CustomTranslationFiles_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'CustomTranslationFiles_AdminPageFramework_Debug', 'oUtil' => 'CustomTranslationFiles_AdminPageFramework_FrameworkUtility', 'oMsg' => 'CustomTranslationFiles_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(CustomTranslationFiles_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return CustomTranslationFiles_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class CustomTranslationFiles_AdminPageFramework_Factory_Model extends CustomTranslationFiles_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class CustomTranslationFiles_AdminPageFramework_Factory_View extends CustomTranslationFiles_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new CustomTranslationFiles_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class CustomTranslationFiles_AdminPageFramework_Factory_Controller extends CustomTranslationFiles_AdminPageFramework_Factory_View {
...
abstract class CustomTranslationFiles_AdminPageFramework_Factory extends CustomTranslationFiles_AdminPageFramework_Factory_Controller {
}
