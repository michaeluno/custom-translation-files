...
abstract class CustomTranslationFiles_AdminPageFramework_Property_Base extends CustomTranslationFiles_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'custom-translation-files' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['aCustomTranslationFiles_AdminPageFramework'])) {
            $GLOBALS['aCustomTranslationFiles_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => CustomTranslationFiles_AdminPageFramework_Registry::NAME, 'sURI' => CustomTranslationFiles_AdminPageFramework_Registry::URI, 'sScriptName' => CustomTranslationFiles_AdminPageFramework_Registry::NAME, 'sLibraryName' => CustomTranslationFiles_AdminPageFramework_Registry::NAME, 'sLibraryURI' => CustomTranslationFiles_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => CustomTranslationFiles_AdminPageFramework_Registry::getVersion(), 'sDescription' => CustomTranslationFiles_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => CustomTranslationFiles_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => CustomTranslationFiles_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => CustomTranslationFiles_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => CustomTranslationFiles_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new CustomTranslationFiles_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
