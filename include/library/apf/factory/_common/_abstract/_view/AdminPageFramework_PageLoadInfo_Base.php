...
abstract class CustomTranslationFiles_AdminPageFramework_PageLoadInfo_Base extends CustomTranslationFiles_AdminPageFramework_FrameworkUtility {
    public $oProp;
    public $oMsg;
    ...
    private function _getPageLoadStats() {
        ...
        return "<div id='custom-translation-files-page-load-stats'>" . "<ul>" . "<li>" . sprintf($this->oMsg->get('queries_in_seconds'), $_nQueryCount, $_nSeconds) . "</li>" . "<li>" . sprintf($this->oMsg->get('out_of_x_memory_used'), $_nMemoryUsage, $_nMemoryLimit, round(($_nMemoryUsage / $_nMemoryLimit), 2) * 100 . '%') . "</li>" . "<li>" . sprintf($this->oMsg->get('peak_memory_usage'), $_nMemoryPeakUsage) . "</li>" . "<li>" . sprintf($this->oMsg->get('initial_memory_usage'), $_sInitialMemoryUsage) . "</li>" . "</ul>" . "</div>";
    }
