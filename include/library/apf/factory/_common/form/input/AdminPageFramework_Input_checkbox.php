...
abstract class CustomTranslationFiles_AdminPageFramework_Input_Base extends CustomTranslationFiles_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'custom-translation-files-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'custom-translation-files-input-label-string',),);
...
class CustomTranslationFiles_AdminPageFramework_Input_checkbox extends CustomTranslationFiles_AdminPageFramework_Input_Base {
