...
class CustomTranslationFiles_AdminPageFramework_FieldType_radio extends CustomTranslationFiles_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".custom-translation-files-field input[type='radio'] {margin-right: 0.5em;} .custom-translation-files-field-radio .custom-translation-files-input-label-container {padding-right: 1em;} .custom-translation-files-field-radio .custom-translation-files-input-container {display: inline;} .custom-translation-files-field-radio .custom-translation-files-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.custom-translation-files-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
