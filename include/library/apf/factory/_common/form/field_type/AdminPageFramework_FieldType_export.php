...
class CustomTranslationFiles_AdminPageFramework_FieldType_submit extends CustomTranslationFiles_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".custom-translation-files-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'custom-translation-files-input-label-container' . ' custom-translation-files-input-button-container' . ' custom-translation-files-input-container',);
    }
...
class CustomTranslationFiles_AdminPageFramework_FieldType_export extends CustomTranslationFiles_AdminPageFramework_FieldType_submit {
