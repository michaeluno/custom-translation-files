...
class CustomTranslationFiles_AdminPageFramework_Form_Model___FormatSectionset extends CustomTranslationFiles_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oCollapsibleArgumentFormatter = new CustomTranslationFiles_AdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset['collapsible'], $_aSectionset['title']);
