...
class CustomTranslationFiles_AdminPageFramework_Form_View___Attribute_SectionTableContainer extends CustomTranslationFiles_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getAttributes() {
        $_aSectionAttributes = $this->uniteArrays($this->dropElementsByType($this->aArguments['attributes']), array('id' => $this->aArguments['_tag_id'], 'class' => $this->getClassAttribute('custom-translation-files-section', $this->getAOrB($this->aArguments['section_tab_slug'], 'custom-translation-files-tab-content', null), $this->getAOrB($this->aArguments['_is_collapsible'], 'is_subsection_collapsible', null)),));
