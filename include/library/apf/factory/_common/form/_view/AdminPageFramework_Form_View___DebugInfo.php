...
class CustomTranslationFiles_AdminPageFramework_Form_View___DebugInfo extends CustomTranslationFiles_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='custom-translation-files-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
