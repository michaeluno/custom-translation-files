...
class CustomTranslationFiles_AdminPageFramework_Form_View___Generate_FieldTagID extends CustomTranslationFiles_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class CustomTranslationFiles_AdminPageFramework_Form_View___Generate_FieldInputID extends CustomTranslationFiles_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
