...
class CustomTranslationFiles_AdminPageFramework_Form_View___Script_Form extends CustomTranslationFiles_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeCustomTranslationFiles_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.custom-translation-files-form-loading' ).remove();
        jQuery( '.custom-translation-files-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.custom-translation-files-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeCustomTranslationFiles_AdminPageFrameworkLoadingOutputs();
