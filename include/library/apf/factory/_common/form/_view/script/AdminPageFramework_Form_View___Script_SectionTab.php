...
class CustomTranslationFiles_AdminPageFramework_Form_View___Script_SectionTab extends CustomTranslationFiles_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.custom-translation-files-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='custom-translation-files-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
