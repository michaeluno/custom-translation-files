...
class CustomTranslationFiles_AdminPageFramework_Form_View___Script_Widget extends CustomTranslationFiles_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.custom-translation-files-sectionset' ).length <= 0 ) { 
                    return; 
                }   
                ...
                $( document ).trigger( 
                    'custom-translation-files_saved_widget', 
                    _oWidget 
                );
