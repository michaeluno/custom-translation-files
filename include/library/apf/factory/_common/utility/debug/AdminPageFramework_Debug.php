...
class CustomTranslationFiles_AdminPageFramework_Debug_Base extends CustomTranslationFiles_AdminPageFramework_FrameworkUtility {
...
class CustomTranslationFiles_AdminPageFramework_Debug_Log extends CustomTranslationFiles_AdminPageFramework_Debug_Base {
...
class CustomTranslationFiles_AdminPageFramework_Debug extends CustomTranslationFiles_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('CustomTranslationFiles_AdminPageFramework_Debug::' . __FUNCTION__, 'CustomTranslationFiles_AdminPageFramework_Debug::dump()');
        CustomTranslationFiles_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('CustomTranslationFiles_AdminPageFramework_Debug::' . __FUNCTION__, 'CustomTranslationFiles_AdminPageFramework_Debug::get()');
        return CustomTranslationFiles_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('CustomTranslationFiles_AdminPageFramework_Debug::' . __FUNCTION__, 'CustomTranslationFiles_AdminPageFramework_Debug::log()');
        CustomTranslationFiles_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('CustomTranslationFiles_AdminPageFramework_Debug::' . __FUNCTION__);
