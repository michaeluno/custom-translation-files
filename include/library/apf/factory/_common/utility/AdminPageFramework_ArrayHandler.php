...
class CustomTranslationFiles_AdminPageFramework_FrameworkUtility extends CustomTranslationFiles_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = CustomTranslationFiles_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return CustomTranslationFiles_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class CustomTranslationFiles_AdminPageFramework_ArrayHandler extends CustomTranslationFiles_AdminPageFramework_FrameworkUtility {
    public $aData = array();
