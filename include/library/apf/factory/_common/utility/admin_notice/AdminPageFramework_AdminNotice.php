...
class CustomTranslationFiles_AdminPageFramework_AdminNotice extends CustomTranslationFiles_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'custom-translation-files-settings-notice-message', 'custom-translation-files-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new CustomTranslationFiles_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
