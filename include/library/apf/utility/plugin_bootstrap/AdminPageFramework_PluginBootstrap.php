...
abstract class CustomTranslationFiles_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('CustomTranslationFiles_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new CustomTranslationFiles_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
