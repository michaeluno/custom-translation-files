 ...
 * @since    0.0.1
 */
class CustomTranslationFiles_Option_Base extends CustomTranslationFiles_PluginUtility {
    ...
    public function getDefaults() {
        return apply_filters(
            CustomTranslationFiles_Registry::HOOK_SLUG . '_filter_default_options',
            CustomTranslationFiles_Registry::$aOptions
        );
    }    
    ...
    public function hasUpgraded() {
        ...
        $_sCurrentVersion       = $this->_getVersionByDepth( CustomTranslationFiles_Registry::VERSION );
