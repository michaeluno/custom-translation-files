 ...
 * @since       0.0.3
 */
abstract class CustomTranslationFiles_AdminPage__InPageTab_Base extends CustomTranslationFiles_AdminPage__Element_Base {
    ...
    protected function _doDebug( $oFactory ) {
        ...
        echo CustomTranslationFiles_AdminPageFramework_Debug::getDetails(
