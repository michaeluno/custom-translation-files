 ...
 * @since    0.0.3
 */
class CustomTranslationFiles_AdminPage__FormSection_DoReset extends CustomTranslationFiles_AdminPage__FormSection_Base {
    ...
    protected function _getFields( $oFactory ) {
        return array(
            array(
                ...
                'title'             => __( 'Reset Options', 'custom-translation-files' ),
                'type'              => 'checkbox',
                'label'             => __( 'I understand the options will be erased by pressing the reset button.', 'custom-translation-files' ),
                'save'              => false,
                'value'             => false,
            ),
            array(
                ...
                'value'             => __( 'Reset', 'custom-translation-files' ),
            )
        );
