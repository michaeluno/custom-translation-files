 ...
 */
$_sMainPluginFileName  = 'custom-translation-files.php';
if ( file_exists( dirname( __FILE__ ). '/' . $_sMainPluginFileName ) ) {
   include( $_sMainPluginFileName );
}

if ( ! class_exists( 'CustomTranslationFiles_Registry' ) ) {
    return;
}
...
// 1. Delete transients
$_aPrefixes = array(
    CustomTranslationFiles_Registry::TRANSIENT_PREFIX, // the plugin transients
...
array_walk_recursive( 
    CustomTranslationFiles_Registry::$aOptionKeys, // subject array
    'delete_option'   // function name
);

// Delete custom tables
foreach( CustomTranslationFiles_Registry::$aDatabaseTables as $_aTable ) {
